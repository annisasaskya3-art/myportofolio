...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "annisa-saskya-myportofolio.pws.cs.ui.ac.id"]
...
SECRET_KEY = 'django-insecure-6g!f&9lx_r2)+(6*4w%26o&*%y4(32z@#0*p!$b%me19nzdbwu'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # <-- DIUBAH DI SINI
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
